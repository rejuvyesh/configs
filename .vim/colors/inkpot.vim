...
if has("gui_running")
    ...
    exec "hi Folded         cterm=NONE   ctermfg=" . <SID>X(79) . " ctermbg=" . <SID>X(82)
    exec "hi FoldColumn     cterm=NONE   ctermfg=" . <SID>X(39) . " ctermbg=" . <SID>X(80)

    exec "hi Directory      cterm=NONE   ctermfg=" . <SID>X(28) . " ctermbg=" . "NONE"
    exec "hi LineNr         cterm=NONE   ctermfg=" . <SID>X(53) . " ctermbg=" . "NONE"
    ...
    exec "hi Number         cterm=NONE   ctermfg=" . <SID>X(64) . " ctermbg=" . "NONE"
    ...
    exec "hi TabLine        cterm=BOLD   ctermfg=" . <SID>X(53) . " ctermbg=" . <SID>X(81)
    exec "hi TabLineFill    cterm=BOLD   ctermfg=" . <SID>X(87) . " ctermbg=" . <SID>X(81)
